...
import pandas as pd
class GetModelCamId():
    def get_data(connection,location_id=None,customer_id=None,subsite_id=None,zone_id=None,camera_group_id=None,logger=None):
        """
        ...
        query1=f"""SELECT cm.camera_id from  camera_master cm
                
                inner join camera_group_list cgl on cgl.camera_id=cm.camera_id
        ...
        query2=f"""SELECT cm.camera_id from  camera_master cm
        ...
        query3=f"""SELECT cm.camera_id from  camera_master cm
        ...
        query4=f"""SELECT cm.camera_id from  camera_master cm
        ...
        query5=f"""SELECT cm.camera_id from  camera_master cm
        ...
        query6=f"""SELECT cm.camera_id from  camera_master cm
        ...
        query7=f"""SELECT cm.camera_id from  camera_master cm
                ...
                inner join zone_master zm on zm.subsite_id = sm.subsite_id
                where  sm.is_deleted=0 and lm.is_deleted=0 and cg.is_deleted=0 and zm.is_deleted=0"""
        query8=f"""SELECT cm.camera_id from  camera_master cm
                ...
                inner join subsite_master sm on cg.location_id=sm.location_id 
                inner join zone_master zm on zm.subsite_id = sm.subsite_id
                where  sm.is_deleted=0 and lm.is_deleted=0 and cg.is_deleted=0 and zm.is_deleted=0 and cg.camera_group_id in {camera_group_id}"""
